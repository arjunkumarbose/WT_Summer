  ...
  function email_check()
  {
    ...
    if (em_check) 
    {
        document.getElementById("erroremail").innerHTML="Mail seems good! :D";
        return true;
    }
    else
    {
  ...
  function age_check()
  {
    ...
    if (age_check) 
    {
        document.getElementById("errorage").innerHTML="Age seems good! :D";
        return true;
    }
    else
    {
        document.getElementById("errorage").innerHTML="Age contains alphabets!";
        return false;
    }
  }
  function pass_check()
  {
    ...
    if (pass_check) 
    {
        document.getElementById("errorpass").innerHTML="pass seems good! :D";
        return true;
    }
    else
    {
